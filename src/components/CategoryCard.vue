          ...
          <div class="">
            <div class="relative overflow-hidden">
              ...
              <span v-show="card.isTop"
                class="top-flag absolute bottom-[10px] -left-[25px] bg-[#1F85E2] pt-1 pb-[6px] px-8 rotate-45">top</span>
            </div>
            <div class="flex ml-[16px] mt-[16px]">
              <span class="mr-[4px]"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                  ...
                  <g clip-path="url(#clip0_2648_14561)">
                    <path
                      ...
                      stroke="#58B32B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <defs>
            ...
            <div>
                ...
                <span class="mr-[6px]">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="#3A4138" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                </span>
              ...
              <div class="flex ml-[16px]">
                <span class="mr-[6px]">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.1875 4.5H15.1875" stroke="#3A4138" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M6.1875 9H15.1875" stroke="#3A4138" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M6.1875 13.5H15.1875" stroke="#3A4138" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path
                ...
                <div class="flex gap-[8px]">
                  <span><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        ...
                        stroke="#58B32B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      <rect x="1" y="1" width="38" height="38" rx="4" stroke="#DEF0D5" stroke-width="2" />
                    </svg>
                  </span>
                  <span><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
