      ...
      <div class="flex-grow space-y-6">
        <div class="flex items-center justify-between">
          ...
          >
            ...
            <div
              v-show="count > 0"
              class="text-white bg-[#32b32b] p-1 rounded-full w-5 h-5 notification"
            >
              {{ count }}
            </div>
          </a-button>
          <div class="flex items-center justify-between gap-3">
            ...
            <a-dropdown>
              <a
                class="ant-dropdown-link flex items-center gap-[88px] border border-[#DEE6DC] w-fit px-[18px] py-3 rounded-[6px] sort"
                @click.prevent
              >
                Sort By:
                <DownIcon />
